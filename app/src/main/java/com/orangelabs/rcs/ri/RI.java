...
public class RI extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = {
                ...
                "BasicMapDemoV1Activity", "BasicMapDemoV2Activity"
                };
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        switch (position) {
            ...
            case 10:
                startActivity(new Intent(this, BasicMapDemoV1Activity.class));
                break;

            case 11:
                startActivity(new Intent(this, BasicMapDemoV2Activity.class));
                break;
